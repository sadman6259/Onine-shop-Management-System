...
namespace EcommersShopAdmin.Controllers
{
    public class LatestProductController : Controller
    {
        ...
        {
            return View(db.LatestProducts.ToList());
        }
        ...
        public ActionResult Create([Bind(Include="Id,ProductName,Price,ProductCode,AddedDate,AvailableQuantity,ProductReview,ImagePath")] LatestProduct latestproduct)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,ProductName,Price,ProductCode,AddedDate,AvailableQuantity,ProductReview,ImagePath")] LatestProduct latestproduct)
        {
            if (ModelState.IsValid)
            {
