...
namespace EcommersShopAdmin.Controllers
{
    public class CategoryController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="CatId,CategoryName,ProductName,Price,ProductCode,AddedDate,AvailableQuantity,ProductReview,ImagePath")] Category category)
        {
            if (ModelState.IsValid)
            {
