...
namespace EcommersShop.Controllers
{
    public class DetailsProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="DetailsID,AvailableQuantity,AddedDate,ProductReview,ProductID,CategoryID,LatestID")] DetailsProduct detailsproduct)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="DetailsID,AvailableQuantity,AddedDate,ProductReview,ProductID,CategoryID,LatestID")] DetailsProduct detailsproduct)
        {
            if (ModelState.IsValid)
            {
